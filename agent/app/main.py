...
Schema:
{
  ...
  "risk_categories": string[],           // e.g. ["AML", "Fraud", "Sanctions", "Operational", "DataPrivacy"]
  "red_flags": string[],                 // bullet-like short strings
  "missing_information": string[],       // what else is needed to confirm
