...
curl http://16.171.148.87:8001/health | jq

curl http://localhost:8001/risk | jq
curl http://16.171.148.87:8001/risk | jq
...
curl -X POST http://16.171.148.87:8001/transactions -H "Content-Type: application/json" -d '{
    "transaction_id": "TX-1002",
    "timestamp": "2026-02-17T10:02:11Z",
    "customer_id": "CUST-11209",
    "customer_country": "Finland",
